# TouchPortal HardwareMonitor (v1.x — legacy)

> [!WARNING]
> **This documents the legacy Node.js v1.x plugin.** The current plugin is a full C# rewrite (v2.x) — see the main **[README](README.md)**. This page is kept for reference only.
